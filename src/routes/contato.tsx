      ...
      <section className="py-16 sm:py-20 bg-brand-cream">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid gap-12 lg:grid-cols-2 lg:items-start">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={t} className="flex gap-4 rounded-2xl bg-white p-5 shadow-sm">
                  <div className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-brand-cream text-[#005F8F] ring-1 ring-[#005F8F]/15">
          ...
          <form className="rounded-3xl bg-white p-8 shadow-md space-y-4" onSubmit={(e)=>e.preventDefault()}>
            ...
            <button className="w-full rounded-full bg-[#005F8F] py-3 font-bold text-white hover:bg-[#003F66] transition-colors">Enviar mensagem</button>
          </form>
        </div>
      </section>
    </>
