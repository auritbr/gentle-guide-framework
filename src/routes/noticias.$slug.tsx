    ...
    <>
      ...
      <section className="py-14 bg-brand-cream border-t border-brand-earth/15 text-center">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <Link to="/como-ajudar" className="mt-7 inline-flex items-center gap-2 rounded-full bg-brand-gold px-7 py-3 font-bold text-white hover:bg-[#0077B6] transition-colors">
