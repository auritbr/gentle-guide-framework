      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <a href="#" className="inline-flex items-center gap-2 rounded-full bg-brand-gold px-6 py-3 text-sm font-bold uppercase tracking-wider text-white shadow-md hover:bg-[#0077B6] transition-colors">
              <Download className="h-4 w-4" /> Baixe a cartilha aqui
            </a>
          </div>
        </div>
