      ...
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between gap-6 px-4 sm:px-6 lg:h-[88px] lg:px-8">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link
            ...
            className="hidden sm:inline-flex items-center justify-center whitespace-nowrap rounded-full bg-brand-earth px-4 py-2 text-[13px] font-bold uppercase tracking-[0.08em] text-white shadow-md hover:bg-brand-darker transition-colors"
          >
            Apoie Agora
          </Link>
          <button
        ...
        <div className="lg:hidden border-t border-white/10 bg-brand-dark/95 backdrop-blur-md">
          <div className="mx-auto max-w-7xl px-4 py-4 space-y-1">
            ...
            <Link
              to="/como-ajudar/doacao-financeira"
              onClick={() => setOpen(false)}
              className="mt-3 block rounded-full bg-brand-earth px-5 py-3 text-center text-sm font-bold uppercase tracking-wider text-white hover:bg-brand-darker transition-colors"
            >
              Apoie Agora
            </Link>
          </div>
