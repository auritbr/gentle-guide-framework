  ...
  return (
    <>
      <button
        ...
        className="grid h-[42px] w-[42px] sm:h-[46px] sm:w-[46px] place-items-center rounded-full bg-[#E31919] text-white shadow-[0_8px_20px_rgba(180,20,20,0.30)] ring-1 ring-black/5 hover:bg-[#B81414] hover:scale-110 transition-all focus:outline-none focus-visible:ring-4 focus-visible:ring-[#E31919]/40"
      >
