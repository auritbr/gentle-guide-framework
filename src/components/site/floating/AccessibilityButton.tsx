  ...
  return (
    <>
      <button
        ...
        className="grid h-[42px] w-[42px] sm:h-[46px] sm:w-[46px] place-items-center rounded-full bg-white text-[#00A8FF] shadow-[0_8px_20px_rgba(0,80,140,0.15)] ring-1 ring-[#00A8FF]/40 hover:bg-[#00A8FF] hover:text-white hover:ring-[#00A8FF] hover:scale-110 transition-all focus:outline-none focus-visible:ring-4 focus-visible:ring-[#00A8FF]/40"
      >
