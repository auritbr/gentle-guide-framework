      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          {COLUMNS.map((col) => (
            <div key={col.title}>
              ...
              <ul className="mt-4 space-y-2.5 text-sm">
                {col.links.map((l) => (
                  <li key={l.label}>
                    <a href={l.to} className="text-white/70 hover:text-brand-gold transition-colors">
                      {l.label}
                    </a>
                  </li>
                ))}
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-2 text-sm text-white/75 break-words">contato@familiahundeso.org.br</p>
          </div>
          <div>
            <h5 className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-brand-gold">
              <Phone className="h-4 w-4" /> Telefone / WhatsApp
            </h5>
            <p className="mt-2 text-sm text-white/75">(82) 99618-0034</p>
          </div>
          <div>
            <h5 className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-brand-gold">
          ...
          <div>
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {[
                ...
                <a key={label} href={href} aria-label={label} className="grid h-9 w-9 place-items-center rounded-full bg-white/10 text-white ring-1 ring-white/15 hover:bg-brand-gold hover:text-white transition">
