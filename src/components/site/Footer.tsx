...
export function Footer() {
  return (
    <footer className="bg-white text-[#003F66] border-t-2 border-[#00A8FF]/30 shadow-[inset_0_1px_0_rgba(0,168,255,0.08)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-6">
          ...
          {COLUMNS.map((col) => (
            <div key={col.title}>
              <h4 className="text-sm font-bold uppercase tracking-wider text-[#00A8FF]">
                {col.title}
              </h4>
              <ul className="mt-4 space-y-2.5 text-sm">
                {col.links.map((l) => (
                  <li key={l.label}>
                    <a href={l.to} className="text-[#003F66]/80 hover:text-[#00A8FF] transition-colors">
                      {l.label}
                    </a>
                  </li>
                ))}
        ...
        <div className="my-12 h-px bg-[#00A8FF]/20" />

        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <h5 className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#00A8FF]">
              <Mail className="h-4 w-4" /> E-mail
            </h5>
            <p className="mt-2 text-sm text-[#003F66]/80 break-words">contato@familiahundeso.org.br</p>
          </div>
          <div>
            <h5 className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#00A8FF]">
              <Phone className="h-4 w-4" /> Telefone / WhatsApp
            </h5>
            <p className="mt-2 text-sm text-[#003F66]/80">(82) 99618-0034</p>
          </div>
          <div>
            <h5 className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#00A8FF]">
              <MapPin className="h-4 w-4" /> Endereço
            </h5>
            <p className="mt-2 text-sm text-[#003F66]/80 leading-relaxed">
              Sítio Hùndésô - S/N - Comunidade Riacho Branco, Região Serrana dos Quilombos, zona rural — Joaquim Gomes/AL. CEP: 57980-000.
            </p>
          </div>
          <div>
            <h5 className="text-xs font-bold uppercase tracking-wider text-[#00A8FF]">Conecte-se</h5>
            <div className="mt-3 flex flex-wrap gap-2">
              {[
                ...
                <a key={label} href={href} aria-label={label} className="grid h-9 w-9 place-items-center rounded-full bg-[#E6F7FF] text-[#003F66] ring-1 ring-[#00A8FF]/30 hover:bg-[#00A8FF] hover:text-white transition">
        ...
        <div className="mt-12 border-t border-[#00A8FF]/20 pt-6 text-center text-xs text-[#003F66]/65 space-y-1">
